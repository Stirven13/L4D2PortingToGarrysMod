...
* [Как экспортировать Source Engine файлы в Blender](#как-экспортировать-source-engine-файлы-в-blender)
...
# Как экспортировать Source Engine файлы в Blender
...
4. TODO написать про то что кости могут быть говно и надо удалить ссылаясь на нижний какой-то там пункт
...
## Кости
Кости можно отобразить при помощи пяти способов, при помощи поля `Display As`:  
